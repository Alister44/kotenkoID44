...
public class Main {
    public static void main(String[] args) {
        ...
        Matrix matrix = matrixManager.createList(50, 4, 4, "Kotenko");
     ...
     //   matrixManager.showMatrix(matrix);
        ...
        try {
            ...
            MatrixWriteRead.write(matrix, "C:\\Users\\Admin\\Documents\\универ\\testToWrite.json");
        } catch (IOException e) {
        ...
        try {
            ...
            readMatrix = MatrixWriteRead.read("C:\\Users\\Admin\\Documents\\универ\\testToRead.json");
